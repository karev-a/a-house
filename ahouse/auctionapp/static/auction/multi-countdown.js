    ...
    function dateReplace(extraClass, date, fixTime, initText, zeroPad) {
        ...
        if (dif[0] < 0 || dif[1] < 0 || dif[2] < 0 || dif[3] < 0) {
           ...
           if(zeroPad != undefined) zeroPadArr = JSON.parse(zeroPad);
            ...
            if (zeroPadArr['Days'] != "false") dif[0] = String(dif[0]).padStart(1, '0');
            if (zeroPadArr['Hours'] != "false") dif[1] = String(dif[1]).padStart(1, '0');
            if (zeroPadArr['Minutes'] != "false") dif[2] = String(dif[2]).padStart(1, '0');
            if (zeroPadArr['Seconds'] != "false") dif[3] = String(dif[3]).padStart(1, '0');
